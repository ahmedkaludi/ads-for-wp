...
// Metaboxes field selection on different dropdown selection       
    ...
    $("#select_adtype").change(function(){        
          $(this).find("option:selected").each(function(){
              ...
              if(optionHtml){ 
                  ...
                  $("#select_adtype").parent().find('p').remove('.ezoic_notice');    
                  $("#select_adtype").parent().find('p').remove('.engageya_notice');    
                  $("#select_adtype").parent().find('p').remove('.infolinks_notice');    
                  switch (optionValue) {
                    case "mediavine":
                      $("#display-metabox").show();
                      $("#adsforwp_visitor_condition_metabox, #adsforwp_placement_metabox").show();             
                      $("#mediavine_site_id").attr("required",true);
                      $("#mediavine_site_id").parent().parent("tr").show();
                    break;
                    case "engageya":
                        $("#display-metabox").show();
                        $("#adsforwp_visitor_condition_metabox, #adsforwp_placement_metabox").show();
                        $("#engageya_site_id").attr("required",true);
                        $("#engageya_widget_ids").attr("required",true);
                        $("#engageya_publisher_id").attr("required",true);
                        $("#engageya_site_id").parent().parent("tr").show();
                        $("#engageya_widget_ids").parent().parent("tr").show();
                        $("#engageya_publisher_id").parent().parent("tr").show();
                        $("#banner_size, #adsforwp_ad_responsive").parent().parent("tr").show();
                        $("#select_adtype").parent().append('<p class="engageya_notice"><i>Note: This Ad type is not implemented in Non-AMP</i>.</p>');
                    break;
                    case "ezoic":
                      $("#display-metabox").hide();
                      $("#adsforwp_visitor_condition_metabox, #adsforwp_placement_metabox").show();             
                      $("#ezoic_slot_id").attr("required",true);
                      $("#ezoic_slot_id").parent().parent("tr").show();
                      $("#select_adtype").parent().append('<p class="ezoic_notice"><i>Note: This Ad type is not implemented in AMP</i>.</p>');
                    break;
                    case "taboola":
                      $("#display-metabox").show();
                      $("#adsforwp_visitor_condition_metabox, #adsforwp_placement_metabox").show();             
                      $("#taboola_publisher_id").attr("required",true);
                      $("#taboola_publisher_id").parent().parent("tr").show();
                      //$("#adsforwp_ad_responsive").parent().parent("tr").show();
                    break;
                    case "outbrain":
                      $("#display-metabox").show();
                      $("#adsforwp_visitor_condition_metabox, #adsforwp_placement_metabox").show();
                      $("#outbrain_widget_ids").parent().parent("tr").show();                                                             
                      $("#outbrain_type").parent().parent("tr").show();                                                             
                      $("#outbrain_widget_ids").attr("required",true);
                      $("#adsforwp_ad_responsive").parent().parent("tr").show();
                    break;
                    case "mantis":
                        $("#display-metabox").show();
                        $("#adsforwp_visitor_condition_metabox, #adsforwp_placement_metabox").show();
                        $("#mantis_property_id").parent().parent("tr").show();                                                             
                        $("#mantis_property_id").attr("required",true);
                        $("#mantis_display_type").parent().parent("tr").show();                                                             
                        $("#mantis_display_type").attr("required",true);
                                                                                     
                        $("#mantis_zone_name").attr("required",true);
                        $("#adsforwp_ad_responsive").parent().parent("tr").hide();
                        $("#mantis_display_type").change(function(){
                          if($(this).val() == 'display'){
                              $("#mantis_zone_name").parent().parent("tr").show();
                          }else{
                              $("#mantis_zone_name").parent().parent("tr").hide();
                          }
                        }).change(); 
                    break;
                    case "mgid":
                    ...
                    case "custom":
                       ...
                       $("#custom_code").attr("required",true);                                           
                        break;
                    case "adsense":
                        $("#adsense_type").parent().find('p').remove('.in_article_notice');
                      ...
                      switch(adsense_type){
                            case "in_article_ads":
                                ...
                                $("#display-metabox").show();
                                $("#banner_size, #adsforwp_ad_responsive").parent().parent("tr").hide();
                                $("#data_client_id, #data_ad_slot").parent().parent("tr").show();
                                $("#adsense_type").parent().append('<p class="in_article_notice"><i>Note: This AdSense type is not implemented in AMP</i>.</p>');
                                $("#matched_content_type, #matched_content_rows, #matched_content_columns").parent().parent("tr").hide();
                            break; 
                          case "matched_content_ads":
                              $("#display-metabox").show();
                              $("#banner_size").parent().parent("tr").hide();
                              $("#adsforwp_visitor_condition_metabox, #adsforwp_placement_metabox").show();
                              $("#data_client_id, #data_ad_slot, #matched_content_type, #matched_content_rows, #matched_content_columns").parent().parent("tr").show();
                              $("#data_client_id, #data_ad_slot, #matched_content_type, #matched_content_rows, #matched_content_columns").attr("required",true);
                    ...
                    case "doubleclick":
                      ...
                      $("#adsforwp_visitor_condition_metabox, #adsforwp_placement_metabox").show();
                      $("#banner_size,#adsforwp_ad_responsive").parent().parent("tr").show();
                      $("#dfp_multisize_ads").parent().parent("tr").show();
                      
                      $(".adsforwp_dfp").show(); 
                      $("#dfp_multisize_ads").change(function(){
                        if($(this).is(':checked')){
                            $("#dfp_multisize_ads_sizes").parent().parent("tr").show();
                            $("#dfp_multisize_validation").parent().parent("tr").show();
                        }else{
                            $("#dfp_multisize_ads_sizes").parent().parent("tr").hide();
                            $("#dfp_multisize_validation").parent().parent("tr").hide();
                        }
                      }).change();                                                                                                                     
                    ...
                    case "infolinks":
                      ...
                      $("#select_adtype").parent().append('<p class="infolinks_notice"><i>Note: This Ad type is not implemented in AMP</i>.</p>');
                        break     
          ...
          if(optionValue){
              ...
              switch (optionValue) {
                  ...
                  case "matched_content_ads":
                    $("#banner_size, #adsforwp_ad_responsive").parent().parent("tr").hide();
                    $("#data_client_id, #data_ad_slot, #matched_content_type, #matched_content_rows, #matched_content_columns").parent().parent("tr").show();
                    $("#data_client_id, #data_ad_slot").attr("required",true);                    
                    $("#banner_size").attr("required",false);                    
                    $("#display-metabox").show();
                    $("#adsforwp-location").show();
                    $("#adsforwp_visitor_condition_metabox, #adsforwp_placement_metabox").show();
                ...
                case "adsense_auto_ads":
                  ...
                  // $("#adsforwp-location").hide();   
                   $("#adsforwp_visitor_condition_metabox").hide();
                   $("#data_client_id").parent().parent("tr").show();
                   $("#banner_size, #data_ad_slot, #adsforwp_ad_responsive, #matched_content_type, #matched_content_rows, #matched_content_columns").parent().parent("tr").hide();
    ...
    $(".adsforwp-precentage-content").click(function(e){
        e.preventDefault();
        $("#percent_content").parent().parent("tr").toggle();
    }).change();
      ...
      $(this).find("option:selected").each(function(){     
          ...
          if(optionValue){
              ...
              $(".afw_ad_img_margin").parent().parent("tr").show();
               ...
               $(".adsforwp-precentage-content").hide();
              switch (optionValue) {
                 case "between_the_content":
                    ...
                    }else if( pragraph_no ==='50_of_the_content'){
                        $(".adsforwp-precentage-content").show();
                    }
                    $("#adposition").parent().parent("tr").show();                    
                    $("#ads_text_wrap").parent().parent("tr").show();                    
      ...
      $(this).find("option:selected").each(function(){  
          ...
          if(optionValue){                                 
              if("number_of_paragraph" === optionValue && wheretodisplay ==='between_the_content'){
                ...
                if(tagval == 'div_tag' || tagval == 'img_tag' || headings.includes(tagval)) {
                 $("#display_tag_name").parent().parent("tr").show();    
                } 
