    ...
    for (var key in adtype_metafields) {
        ...
        if(obj.required){
            ...
            switch(ftypeobj){
                case "and":
                     var overAll = [];
                    $.each(obj.required.fields, function(key,val){
                    ...
                    if(overAll.length==1 && overAll[0]==true){
                        $("#"+obj.id).parents("tr").show();
                    }else{
                        $("#"+obj.id).parents("tr").hide();
                    }
                break;
                case "or":
                     var overAll = [];
...
$("#select_adtype").change(function(){
    $(this).find("option:selected").each(function(){
        ...
        $("#select_adtype").parent().find('p').remove('.adnow_notice');         
        $("#select_adtype").parent().find('p').remove('.ampstory_notice');         
        if(optionHtml){
            ...
            switch (optionValue) {
                case "amp_story_ads":
                    if(amp_story_ads_feature.amp_story_ad == false){
                        $("#select_adtype").parent().append('<p class="ampstory_notice"><i>Note: Need AMP Story feature inorder to use this Ad Type</i>.</p>');
                    }
                    $("#display-metabox,#setexpiredate,#adsforwp-location").hide();
                    $("#adsforwp_visitor_condition_metabox, #adsforwp_placement_metabox").hide();
                break;
                case "mediavine":
                ...
                break;
                case "ad_now":
                    $("#select_adtype").parent().append('<p class="adnow_notice"><i>Note: This Ad type is not implemented in AMP</i>.</p>');
                    $("#display-metabox").show();
                    $("#adsforwp_visitor_condition_metabox, #adsforwp_placement_metabox").show();
                ...
                break;
                case "engageya":
                    $("#display-metabox,#adsforwp_visitor_condition_metabox, #adsforwp_placement_metabox").show();
        ...
        if(optionValue){
          switch (optionValue) {
              ...
              case "matched_content_ads":
                $("#display-metabox,#adsforwp-location,#adsforwp_visitor_condition_metabox,#adsforwp_placement_metabox").show();
            ...
            case "adsense_sticky_ads":
                $("#display-metabox,#adsforwp-location").hide();
                $("#adsforwp_visitor_condition_metabox, #adsforwp_placement_metabox").show(); 
                break;
            case "adsense_auto_ads":
                ...
                $("#display-metabox,#adsforwp_visitor_condition_metabox").hide();
                // $("#adsforwp-location").hide();
                $.ajax({
