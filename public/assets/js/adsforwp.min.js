...
/* Visitor Conditions jquery starts here */
        ...
        var adsforwpvisitorremoveHtml = function(){
                    jQuery(".adsforwp-visitor-condition-row-delete").off("click").click(function(){
                            ...
                            var button = '<div class="adsforwp-visitor-condition-div"><a class="adsforwp-enable-click afw-placement-button">Enable Visitor Condition</a><p>Visitor conditions limit the number of users who can see your ad.</p></div>';
                            if(class_count==1){
                                if(jQuery(this).parents("tbody").find("tr").length>1){
                                         jQuery(this).parents("tr").remove();
                                }else{
