 ...
 */
class Adsforwp_Google_Cache_Apc extends Adsforwp_Google_Cache_Abstract
{
  public function __construct(Adsforwp_Google_Client $client)
  {
    if (! function_exists('apc_add') ) {
      throw new Adsforwp_Google_Cache_Exception("Apc functions not available");
    }
  }
  ...
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      throw new Adsforwp_Google_Cache_Exception("Couldn't store data");
    }
  }
