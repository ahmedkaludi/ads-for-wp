...
class Adsforwp_Google_Config
{
  ...
  /**
   * Create a new Adsforwp_Google_Config. Can accept an ini file location with the
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'Adsforwp_Google_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'Adsforwp_Google_Cache_File',
      ...
      'classes' => array(
        'Adsforwp_Google_IO_Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'Adsforwp_Google_Http_Request' => array(
        ...
        'Adsforwp_Google_Auth_OAuth2' => array(
        ...
        'Adsforwp_Google_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/Adsforwp_Google_Client'
        )
      ),
